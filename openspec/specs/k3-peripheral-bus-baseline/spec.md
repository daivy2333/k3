# k3-peripheral-bus-baseline Specification

## Purpose

建立 K3 I2C、USB、PCIe、CAN 和 EtherCAT 的可追溯总线知识契约，使读者能够按总线查询控制器资源、对象边界、协议依赖、板级连接、运行结果和未知项，并区分官方事实、官方软件行为、固定 revision 第三方经验、推论与未验证状态。
